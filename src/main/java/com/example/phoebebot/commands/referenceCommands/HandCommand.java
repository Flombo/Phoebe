...
@Component
public class HandCommand implements SlashCommand {

    private final ReferenceCommands commandName = ReferenceCommands.hand;
    private final IReferenceService referenceService;
    private final IReferenceMessageBuilder referenceMessageBuilder;

    public HandCommand(IReferenceService referenceService, IReferenceMessageBuilder referenceMessageBuilder) {
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        String gender = event.getOption("gender")
                ...
                .map(ApplicationCommandInteractionOptionValue::asString).stream().findFirst()
